...
let btn = [{
                        ...
                        semar.send5ButImg(m.chat, anu, 'ARSTORE-ID', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        semar.send5ButGif(m.chat, anu, 'ARSTORE-ID', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        semar.send5ButVid(m.chat, anu, 'ARSTORE-ID', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        semar.send5ButMsg(m.chat, anu, 'ARSTORE-ID', btn)
                        } else if (setbot.templateLocation) {
                        semar.send5ButLoc(m.chat, anu, 'ARSTORE-ID', global.thumb, btn)
                        }
                     }
            break
            case 'mee': {
